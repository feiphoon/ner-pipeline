...
from src.F_synthesise_annotated_abstracts.entity_replacement2 import (
...
interim_entities_replaced_abstracts_filepath: str = (
...
perform_entity_replacement(
    run_input_filepath=run.create_run_filepath(prepared_annotated_abstracts_filepath),
    run_output_filepath=run.create_run_filepath(
        interim_entities_replaced_abstracts_filepath
    ),
    seed=SEED,
)
